        ...
        <div className="flex items-center flex-col-reverse md:flex-row">
          <div>
            ...
            <div className="flex flex-col md:flex-row gap-4">
                <input type="email" placeholder="Email Address" className="w-full md:w-3/5 px-4 py-3 border focus:outline-[#925e0b]" />
                <input type="submit" value="Subscribe" className="text-white bg-[#f39c12] hover:bg-[#925e0b] px-10 py-3 rounded-lg cursor-pointer" />
            </div>
          </div>
          <div>
